...
var refreshPassword = function (req, res) {
    ...
    if (email) {
        if (new_pass) {
            user_controller_1.findByEmail(email).then(function (result) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, user_model_1.User.updateOne({ _id: result[0].id }, req.body)];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, user_model_1.User.findById(result[0].id)];
                        case 2:
                            ref_pass = _a.sent();
                            return [2 /*return*/, res.status(200).json({ message: 'New password has been updated', code: 200, data: ref_pass })];
