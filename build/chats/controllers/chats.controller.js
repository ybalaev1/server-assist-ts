...
var createChat = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, chats_model_1.Chat.create(data)];
            case 1:
                chat = _a.sent();
                return [2, chat];
        }
...
var markMessageRead = function (chat_id, user) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        try {
            return [2, chats_model_1.Message.updateMany({
                    chat_id: chat_id,
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, chats_model_1.Chat.findById(id)];
            case 1:
                chat = _a.sent();
                if (!chat) {
                ...
                return [4, markMessageRead(id, userId)];
            case 2:
                result = _a.sent();
                return [2, res.status(200).json({ success: true, data: result })];
            case 3:
                error_1 = _a.sent();
                return [2, res.status(500).json({ success: false, error: error_1 })];
            case 4: return [2];
        }
    });
}); };
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                jwt = req.body.jwt;
                return [4, chats_model_1.Chat.findById({ _id: id })];
            case 1:
                chat = _a.sent();
                if (!chat) {
                    return [2, res.status(404).json({ message: 'Chat not found' })];
                }
                if (jwt.userId !== chat.users[0] && jwt.userId !== chat.users[1]) {
                    return [2, res.status(404).json({ message: 'Chat not found' })];
                }
                if (chat.users[0] === jwt.userId && chat.users[1] === jwt.userId) {
                    last_1 = (0, decryption_1.decrypt)(chat.latestMessage[0], id);
                    favoriteUser = {
                        user: {
                    ...
                    return [2, res.status(200).json({ data: favoriteUser })];
                }
                return [4, user_model_1.User.findById({ _id: jwt.userId })];
            case 2:
                user = _a.sent();
                user_id = user === null || user === void 0 ? void 0 : user._id.toString();
                currentUser = chat.users.filter(function (u) { return u !== user_id; }).toString();
                return [4, user_model_1.User.findById({ _id: currentUser })];
            case 3:
                costumer = _a.sent();
                last = (0, decryption_1.decrypt)(chat.latestMessage[0], id);
                if (last) {
                    newDataChat_1 = {
                        user: {
                    ...
                    return [2, res.status(200).send({ data: newDataChat_1 })];
                }
                newDataChat = {
                    user: {
                        fullName: costumer === null || costumer === void 0 ? void 0 : costumer.fullName,
                ...
                return [2, res.status(200).send({ data: newDataChat })];
        }
    });
}); };
...
var getChats = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                jwt = req.body.jwt;
                return [4, user_model_1.User.findById({ _id: jwt.userId }).exec()];
            case 1:
                user = _a.sent();
                user_id = user === null || user === void 0 ? void 0 : user._id.toString();
                return [4, chats_model_1.Chat.find({ users: user_id })];
            case 2:
                data = _a.sent();
                chat_messages = data;
                for (i = 0; i < chat_messages.length; i++) {
                    element = chat_messages[i].latestMessage[0];
                    item = (0, decryption_1.decrypt)(element, chat_messages[i]._id);
...
var getMarkerRead = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4, chats_model_1.Message.aggregate([
                        { $match: { chat_id: id } },
                        { $sort: { createdAt: -1 } },
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4, chats_model_1.Message.aggregate([{ $match: { chat_id: id } }, { $sort: { createdAt: 1 } }, { $unwind: '$user_id' }])];
            case 2:
                conversation = _a.sent();
                chat_messages = conversation;
                for (i = 0; i < chat_messages.length; i++) {
                    element = chat_messages[i].message[0];
                    item = (0, decryption_1.decrypt)(element, id);
...
var createMessage = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                hash = (0, encryption_1.encrypt)(data.message, data.chat_id);
                data.message = hash;
                return [4, chats_model_1.Message.create(data)];
            case 1:
                mes = _a.sent();
                mess_id = mes === null || mes === void 0 ? void 0 : mes._id;
                dec_message = (0, decryption_1.decrypt)(data.message, data.chat_id);
                return [4, user_model_1.User.findById({ _id: mes.user_id })];
            case 2:
                last_user = _a.sent();
                return [4, chats_model_1.Chat.findById({ _id: data.chat_id })];
            case 3:
                crntChat = _a.sent();
                markMessageRead(data.chat_id, mes.user_id);
                return [4, chats_model_1.Chat.replaceOne({ _id: data.chat_id }, {
            ...
            case 4:
                ...
                return [2, recievedMessage];
        }
    });
}); };
exports.createMessage = createMessage;
var lattestMessage = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var conversation, chat_messages, i, element, item;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, chats_model_1.Message.find({ chat_id: id }).sort({ createdAt: 1 })];
            case 1:
                conversation = _a.sent();
                chat_messages = conversation;
                for (i = 0; i < chat_messages.length; i++) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                userId = req.body.jwt.userId;
                if (!data) {
                    return [2, res.status(401).json({ message: 'Need data', code: 401 })];
                }
                if (!data.costumer) {
                    return [2, res.status(401).json({ message: 'Need costumer', code: 401 })];
                }
                if (!data.initiator) {
                    return [2, res.status(401).json({ message: 'Need initiator', code: 401 })];
                }
            ...
            case 1:
                ...
                return [2, createChat(data).then(function (createdChat) {
...
var postMessageChat = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        ...
        return [2, createMessage(message_data).then(function (createMess) { return __awaiter(void 0, void 0, void 0, function () {
                var currentChat, lastUser;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, chats_model_1.Chat.findById({ _id: id })];
                        case 1:
                            currentChat = _a.sent();
                            return [4, user_model_1.User.findById({ _id: jwt.userId })];
                        case 2:
                            lastUser = _a.sent();
                            return [4, chats_model_1.Chat.replaceOne({ _id: currentChat === null || currentChat === void 0 ? void 0 : currentChat._id }, {
...
var getSocketTyping = function (user_id) { return __awaiter(void 0, void 0, void 0, function () {
    var user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, user_model_1.User.findById({ _id: user_id })];
            case 1:
                user = _a.sent();
                return [2, user];
        }
...
var deleteMessage = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4, chats_model_1.Message.deleteOne({ _id: id })];
            case 1:
                message = _a.sent();
                return [2, res.status(200).json({ message: message })];
        }
    });
}); };
