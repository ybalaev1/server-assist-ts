        ...
        return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                        switch (_a.label) {
                                case 0:
                                        jwt = req.body.jwt;
                                        return [4 /*yield*/, notice_model_1.Notice.find({ user: jwt.userId })];
                                case 1:
                                        notice = _a.sent();
...
var createNoticeForUserId = function (data, user_id, type, socket) {
        return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                        switch (_a.label) {
                                ...
                                case 2:
                                        sender_user = _a.sent();
                                        message = decryption_1.decrypt(data.message, chat === null || chat === void 0 ? void 0 : chat._id);
                                        notice = {
                                                message: '' + message,
                                        ...
                                        return [4 /*yield*/, notice_model_1.Notice.create(notice)];
                                case 3:
                                        new_notice = _a.sent();
