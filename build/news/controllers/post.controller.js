    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, post_model_1.Post.findOne({ _id: postId })];
            case 1:
                post = _a.sent();
                if (!post) {
                    return [2, res.status(404).json({ message: "Post with id " + postId + " not found", code: 404 })];
                }
                return [2, res.status(200).json({ data: post })];
        }
    });
}); };
exports.findById = findById;
var getPostByUser = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, user_model_1.User.findById({ _id: id })];
            case 1:
                user = _a.sent();
                if (user) {
                    return [2, user.posts];
...
var getAllPosts = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4, post_model_1.Post.find().exec()];
            case 1:
                allPosts = _b.sent();
                posts = [];
                i = 0;
                _b.label = 2;
            case 2:
                if (!(i < allPosts.length)) return [3, 5];
                item = allPosts[i];
                return [4, user_model_1.User.findById({ _id: (_a = allPosts[i]) === null || _a === void 0 ? void 0 : _a.user })];
            case 3:
                user = _b.sent();
                updatedPost = {
            ...
            case 4:
                i++;
                return [3, 2];
            case 5: return [2, res.status(200).send({ posts: posts })];
        }
    });
}); };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    _a.label = 2;
                case 2:
                    if (!(p < user.posts.length)) return [3, 5];
                    item = user.posts[p];
                    return [4, post_model_1.Post.findById(item)];
                case 3:
                    searchPost = _a.sent();
                    post = {
...
function insertPostData(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2, postCreate(req.body).then(function (post) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, user_model_1.User.updateOne({ _id: req.body.user }, { $push: { posts: post.id } })];
                            case 1:
                                _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, post_model_1.Post.findById(postId)];
            case 1:
                takePost = _a.sent();
                if (!takePost) return [3, 6];
                return [4, user_model_1.User.updateOne({ _id: userId }, { $pull: { posts: postId } })];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3:
                _a.trys.push([3, 5, , 6]);
                return [4, post_model_1.Post.findByIdAndDelete({ _id: postId })];
            case 4:
                _a.sent();
                getPostByUser(userId).then(function (posts) { return __awaiter(void 0, void 0, void 0, function () {
                    var newsUpdate;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!posts) return [3, 2];
                                return [4, post_model_1.Post.find().exec()];
                            case 1:
                                newsUpdate = _a.sent();
                                return [2, res.status(201).json({ user: posts, news: newsUpdate })];
                            case 2: return [2, posts];
                        }
                    });
                }); });
                return [3, 6];
            case 5:
                error_1 = _a.sent();
                return [2, res.status(403).json({ error: 'error', code: 403 })];
            case 6: return [2, res.status(404).json({ message: 'Post not be found', code: 404 })];
        }
    });
}); };
