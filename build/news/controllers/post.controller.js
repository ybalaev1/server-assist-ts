    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                post = _a.sent();
                if (!post) {
                    return [2 /*return*/, res.status(404).json({ message: "Post with id " + postId + " not found", code: 404 })];
                }
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, postCreate(req.body).then(function (post) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, user_model_1.User.updateOne({ _id: req.body.user }, { $push: { posts: post.id } })];
                            case 1:
                                _a.sent();
...
var deletePost = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
                ...
                getPostByUser(userId).then(function (posts) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                newsUpdate = _a.sent();
                                return [2 /*return*/, res.status(201).json({ user: posts, news: newsUpdate })];
            ...
            case 6: return [2 /*return*/, res.status(404).json({ message: 'Post not be found', code: 404 })];
        }
    });
}); };
